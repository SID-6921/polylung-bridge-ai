...
# Set fake environment variables for testing before importing the app
os.environ["CENSUS_API_KEY"] = "mock_test_key_12345"
os.environ["PSPII_DATA_DIR"] = "./mock_data"

# Import the FastAPI app from scoring.py
...
def test_health_check():
    ...
    assert "message" in response.json()  # Matches your exact backend key!
...
def test_invalid_zip_code_bounds():
    ...
    response = client.post("/score", json=payload)
    # Accepts either 422 or 404 based on your backend router setup
